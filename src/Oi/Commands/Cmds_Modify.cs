namespace Oi.Commands.Cmds_Modify
{
    ...
    public class Cmd_SelectProtectedElements : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            var protectedIds = Protection.ManagerRegistry.ModifySchemaManager.GetProtectedElementIds(doc);
    ...
    public class Cmd_ProtectionReview : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<ElementId> protectedIds = uidoc.Selection.GetElementIds()
                .Where(id => Protection.ManagerRegistry.ModifySchemaManager.IsProtected(doc, id))
                .ToList();
            ...
            List<ProtectionReviewItem> reviewItems = Protection.ManagerRegistry.ModifySchemaManager.GetProtectionReviewItems(doc, protectedIds);
    ...
    public class Cmd_ProtectSelectedElements : IExternalCommand
    {
        ...
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            List<Element> unprotectedElements = uidoc.Ext_SelectedElements()
                .Where(e => !Protection.ManagerRegistry.ModifySchemaManager.IsProtected(doc, e.Id))
                .ToList();
