...
namespace Oi.Extensions
{
    ...
    public static class UIControlledApplication_Ext
    {
        ...
        /// <param name="tabName">The name of the tab on which to search.</param>
        /// <returns>A RibbonPanel.</returns>
        public static RibbonPanel Ext_GetRibbonPanelByName(this UIControlledApplication uiApp, string panelName, string tabName = null)
        {
            tabName ??= Globals.ADDIN_NAME;
