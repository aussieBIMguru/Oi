...
{
    /// <summary>
    /// This failure is raised when Elements protected by the related ExtensibleStorage Schema are modified.
    /// The transaction is rolled back, and this Failure is raised by Revit.
    /// </summary>
    public class ModifyFailure
    {
        /// <summary>
        ...
        public static FailureDefinition Definition = FailureDefinition.CreateFailureDefinition(
            Id, FailureSeverity.Error, "Element(s) are protected from being modified.\n\n" +
